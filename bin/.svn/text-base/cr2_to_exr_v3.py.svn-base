...
def help():
	...
	"""
	text = """\nusage: %s <CR2 image file directory or directories> [-pt <threads>] [PhotomatixCL arguments]\n
	The number of python threads to use for processing the image sequence
	can be specified with:
		-pt <number of threads>	 (default is 3)
